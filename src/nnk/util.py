...
def correct_alignment(X: pd.Series, field_1: str, field_2: str) -> pd.Series:
    ...
    try:
        ...
        alignments = pairwise2.align.globalms(
            alignment_aa_1, alignment_aa_2, 4, -1, -12, -4, penalize_extend_when_opening=True, penalize_end_gaps=False,
        )
...
def get_consensus_of_paired_end_abi(abi_file_1: Union[str, Path], abi_file_2: Union[str, Path]) -> str:
    ...
    alignments = pairwise2.align.globalms(
        seq_1, seq_2.reverse_complement(), 4, -1, -12, -4, penalize_extend_when_opening=True, penalize_end_gaps=False,
    )
